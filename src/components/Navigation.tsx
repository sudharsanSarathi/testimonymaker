import image_b202f9db7574a7ce1d1f828a2bccf33e6d2398c1 from 'figma:asset/b202f9db7574a7ce1d1f828a2bccf33e6d2398c1.png';
import image_bdb86eba36b4f0f47038dfb256f6284c2f490878 from 'figma:asset/bdb86eba36b4f0f47038dfb256f6284c2f490878.png';
...
export function Navigation() {
  ...
  const isActive = (path: string) => {
    if (path === '/') return location.pathname === '/' || location.pathname === '/whatsapp-testimonial-maker';
          ...
          <div className="flex-shrink-0">
            ...
            >
              <div className="w-8 h-8 rounded-lg overflow-hidden">
                <img src={image_b202f9db7574a7ce1d1f828a2bccf33e6d2398c1} alt="Testimonial Maker Logo" className="w-full h-full object-cover" />
              </div>
